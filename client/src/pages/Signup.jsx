    ...
    // form function
        const handleSubmit = async (e) => {
            ...
            try {
                ...
                formDataToSend.append('photo', photo); // Add the photo to the form data

                const res = await axios.post("http://localhost:8000/api/auth/register", {name,password,answer,email});
