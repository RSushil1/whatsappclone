...
//       <div className={`${hideSidebar? 'hidden' : '' } w-full md:w-[30%] border border-green-950  bg-blue-100`}>
//       <Sidebar handleChatWith={handleChatWith} viewProfile={viewProfile}/>
//       </div>
//       <div className={`${hideSidebar? '' : 'hidden' } md:block  md:w-[70%] border border-green-950 bg-blue-100`}>
//         {profile?(
        ...
        <div className='flex flex-row h-screen'>
          <div
            className={`${
              ...
              hideSidebar ? 'w-[30%]' : ''
            } w-full  border border-green-950 bg-blue-100`}
          >
            <Sidebar handleChatWith={handleChatWith} viewProfile={viewProfile} />
          </div>
          <div
            className={`${
              hideSidebar ? '' : 'hidden'
            } md:block  md:w-[70%] border border-green-950 bg-blue-100 relative`}
          >
            {profile ? (
              <>
                <button
                  onClick={handleBackButtonClick}
                  className='mb-4 ml-4 px-2 py-1 rounded absolute'
                >
