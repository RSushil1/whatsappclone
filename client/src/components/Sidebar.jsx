                                    ...
                                    >
                                        <div className=" flex flex-row">
                                            <div className="w-12 h-12">
                                                {chat.user ?
                                                    (<img className="w-12 h-12 rounded-full" src={`http://localhost:8000/api/auth/profile-photo/${chat.user.find(user => user.contactId._id !== auth?.user._id).contactId._id}`} alt="person" />) : (
                                            ...
                                            <div className=" flex flex-row">
                                                ...
                                                <div className="ms-2 w-[10%]">
                                                    <input
                                                        ...
                                                        checked={selectedContacts.some((contact) => contact.contactId === contact._id)}
                                                        onChange={() => handleCheckboxChange(contact._id, contact.email)}
                                                    />
