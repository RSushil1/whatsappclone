...
export default function Sidebar({ handleChatWith, viewProfile }) {
    ...
    const getChats = async () => {
        const res = await axios.get("/api/auth/chats");
    ...
    const handleAddToChat = async () => {
        ...
        const res = await axios.post("/api/auth/chats", withUsers)
        if (res.data.success) {
                                    ...
                                    >
                                        <div className=" flex flex-row">
                                            <div className="w-12 h-12">
                                                {chat.user ?
                                                    (<img className="w-12 h-12 rounded-full" src={`/api/auth/profile-photo/${chat.user.find(user => user.contactId._id !== auth?.user._id).contactId._id}`} alt="person" />) : (
                                        ...
                                        >
                                            <div className=" flex flex-row">
                                                <div className="w-[25%] h-12">
                                                    <img className="w-12 h-12 rounded-full" src={`/api/auth/profile-photo/${contact._id}`} alt="person" />
                                                </div>
